  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white lg:px-6">
      <div className="lg:p-2">
        ...
        <div className="flex flex-row lg:items-center pb-1">
          ...
          <div className="hidden lg:visible lg:flex space-x-2 lg:space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/matheus55391" target="_blank" rel="noopener noreferrer" className="text-[16px] lg:text-[32px] icon-blue-pulse">
              <FaGithub />
            </a>
            <a href="https://www.linkedin.com/in/matheus-felipe-vieira-santiago-5a321a208/" target="_blank" rel="noopener noreferrer" className="text-[16px] lg:text-[32px] icon-blue-pulse">
              <FaLinkedin />
            </a>
            <a href="mailto:matheus.felipe55391@gmail.com" className="text-[16px] lg:text-[32px] icon-blue-pulse">
              <FaEnvelope />
            </a>
          </div>
        </div>
      ...
      <div className="flex lg:hidden space-x-2 lg:space-x-4 pt-12 ">
            <a href="https://github.com/matheus55391" target="_blank" rel="noopener noreferrer" className="text-[26px] icon-blue-pulse">
              <FaGithub />
            </a>
            <a href="https://www.linkedin.com/in/matheus-felipe-vieira-santiago-5a321a208/" target="_blank" rel="noopener noreferrer" className="text-[26px] icon-blue-pulse">
              <FaLinkedin />
            </a>
            <a href="mailto:matheus.felipe55391@gmail.com" className="text-[26px] icon-blue-pulse">
              <FaEnvelope />
            </a>
        </div>
    </div>
